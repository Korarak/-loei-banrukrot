                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto">
                        ...
                        <div id="shipping-label-print" className="bg-white">
                            {isLandscape ? (
                                ...
                                <>
                                    {/* Courier header strip — same structure as the standard portrait
                                        layout below, just tightened for a 76mm (3") roll: smaller type,
                                        a smaller QR, and no room to spare on padding. */}
                                    <div
                                    ...
                                    {/* Label body */}
                                    <div className="border-x border-b border-gray-200 p-2.5 space-y-2.5">
                                            ...
                                            {showQR && (
                                                <div className="flex flex-col items-center shrink-0">
                                                    <div className="p-1 border-2 border-gray-200 rounded-lg overflow-hidden">
                                                        <QRCodeSVG value={qrValue} size={62} />
                                                    </div>
                                                    <p className="text-[6px] text-gray-400 mt-1 font-mono text-center max-w-[68px] break-all leading-tight">
                                                        {qrCaption}
                                                    </p>
                                                </div>
                                            )}
                                        ...
                                        <div className="flex items-end justify-between gap-2">
                                            <div className="min-w-0">
                                                <p className="text-[9px] font-black uppercase tracking-[0.15em] text-gray-400 flex items-center gap-1 mb-1">
                                                    <Store className="h-2.5 w-2.5 shrink-0" /> ผู้ส่ง
                                                </p>
                                                <p className="font-bold text-xs text-gray-900">{storeName}</p>
                                                {storePhone && (
                                                    <p className="text-[10px] text-gray-600">โทร: {storePhone}</p>
                                                )}
                                            </div>
                                            <div className="text-right shrink-0">
